(function() {
    ...
    if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = "https://whatswhats.rpxnow.com";
    ...
    if (typeof janrain.settings.width === 'undefined')janrain.settings.width = "200";
    if (typeof janrain.settings.height === 'undefined')janrain.settings.height = "200";
    if (typeof janrain.settings.providersPerPage === 'undefined')janrain.settings.providersPerPage = "6";
    if (!janrain.settings.actionText)janrain.settings.actionText = "Sign into Counted it";
    ...
    if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = "obhkeijnhkehianlamaa";
    if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = "https://whatswhats.rpxnow.com";
    janrain.settings.permissions = [];
    if (typeof janrain.settings.providers === 'undefined')janrain.settings.providers = ["facebook","googleplus","twitter"];
    if (typeof janrain.settings.noReturnExperience === 'undefined')janrain.settings.noReturnExperience = false;
    if (typeof janrain.settings.facebookAppId === 'undefined')janrain.settings.facebookAppId = "1527421944196800";
    ...
    if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = "https://whatswhats.rpxnow.com";
